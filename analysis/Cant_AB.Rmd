...
cant <- inner_join(A_annual, B_annual)
...
cant <- cant %>%
  mutate(cant_total = tco2_A - tco2_B) %>% 
  select(-c(tco2_A, tco2_B))
 ...
 # i_year = years[1]
  ...
  cant_year %>%
    write_csv(paste(path_preprocessing,
                    "cant_annual_field_AB/cant_", i_year, ".csv",
                    sep = ""))
}
