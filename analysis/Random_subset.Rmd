...
model_resample %>%
  write_csv(paste(path_preprocessing, "random_subset.csv",
                  sep = ""))

```


```{r plot_random_sample_cmorized_data_grid, eval=FALSE}

# read in random model sampling file
model_resample <-
  read_csv(paste(path_preprocessing, "random_subset.csv",
                 sep = ""))
