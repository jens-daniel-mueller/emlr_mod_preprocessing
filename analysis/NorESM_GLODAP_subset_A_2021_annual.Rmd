---
title: "NorESM GLODAP subset variable climate A"
...
# path_cmorized <-
#   "/nfs/kryo/work/updata/reccap2/Models/2D_CO2/NorESM-OC1.2_2D_CO2_v20210301/"
path_cmorized <-
...
# 2d variables
# variables <-
#   c("so", "thetao", "dissicos", "talk", "o2", "no3", "po4", "si")
...
for (i_variable in variables) {
  ...
  for (i_year in years) {
    ...
    model_grid_horizontal <-
      inner_join(Glodap_year_grid_horizontal, variable_data_tibble_year)
    ...
    variable_data_tibble_year_surface <- variable_data_tibble_year %>%
