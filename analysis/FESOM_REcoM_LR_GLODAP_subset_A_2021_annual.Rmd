---
title: "FESOM_REcoM_LR GLODAP subset variable climate A Annual"
...
variable_data_tibble <-
  tidync(paste(path_cmorized, 
    "dissic_FESOM_REcoM_LR_A_1_gr_1980-2018_v20210218.nc",
    sep = ""
  )) %>%
  hyper_tibble()
...
############################ check for model values with box plot
# variable_data_tibble_plot <- variable_data_tibble %>%
#   mutate(depth = factor(depth),
#          depth = factor(depth, levels = rev(levels(depth))))
# 
# print(
#   ggplot(variable_data_tibble_plot, aes(x = dissic,
#                                         y = depth)) +
#     geom_bin2d(binwidth = 0.1) +
#     labs(title = "Check plot for simulated DIC",
#          subtitle = "All years") +
