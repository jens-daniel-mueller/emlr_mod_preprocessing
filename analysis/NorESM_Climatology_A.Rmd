---
title: "NorESM Climatology variable A"
...
path_cmorized       <- "/nfs/kryo/work/updata/reccap2/Models/3D_ALL/NorESM-OC1.2_3D_ALL_v20210301/"
path_preprocessing  <- paste(path_root, "/model/preprocessing/NorESM/", sep = "")
```
...
for (i_variable in variables) {
  ...
  # # convert time variable to year (use when select one specific year as climatology)
